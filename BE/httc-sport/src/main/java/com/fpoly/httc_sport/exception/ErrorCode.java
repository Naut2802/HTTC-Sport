...
public enum ErrorCode {
	...
	PHONE_NUMBER_INVALID(1005, "Số điện thoại không hợp lệ", HttpStatus.BAD_REQUEST),
	USERNAME_INVALID_1(1006, "Tên đăng nhập yêu cầu tối thiểu {min} ký tự và không được có khoảng trống hoặc ký tự đặc biệt", HttpStatus.BAD_REQUEST),
	USERNAME_INVALID_2(1006, "Tên đăng nhập yêu cầu không được có khoảng trống hoặc ký tự đặc biệt", HttpStatus.BAD_REQUEST),
	PASSWORD_INVALID_1(1007, "Mật khẩu yêu cầu thiểu {min} ký tự và không được có khoảng trống hoặc ký tự đặc biệt", HttpStatus.BAD_REQUEST),
	PASSWORD_INVALID_2(1007, "Mật khẩu yêu cầu không được có khoảng trống hoặc ký tự đặc biệt", HttpStatus.BAD_REQUEST),
