...
import ThumbSlider from '../YardDetail/ThumbSlider';
    ...
    return (
        <div className="my-3 container">
            ...
            <Breadcrumbs aria-label="breadcrumb" className="fs-5 mb-2">
                ...
                <Typography className="text-decoration-none text-dark fs-6" variant="h6" noWrap component={Link} to="/san">
                    Danh Sách Sân
                </Typography>
                    ...
                    <Card sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                        ...
                        <div className="row">
                            ...
                            <div className="col-4 d-flex justify-content-end align-items-end">
                                <Typography component={Link} to="/dat-san">
